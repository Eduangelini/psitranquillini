  ...
  return (
    <>
      ...
      <main className='flex flex-col gap-y-4 max-sm:gap-y-14 items-center justify-center'>
        ...
        <h2 className='text-3xl max-sm:text-xl max-sm:mx-8 font-bold text-center my-12'>O QUE MEUS ORIENTADOS ESTÃO DIZENDO:</h2>
        <Swiper
          slidesPerView={1}
          spaceBetween={0}
          loop={true}
          ...
          className="lg:w-6/12 w-11/12 h-12/12"
        >
          <SwiperSlide className=''>
            <div className='shadow-default rounded-lg p-8 flex flex-col justify-center gap-y-3 mx-2 mb-14 mt-2 max-sm:h-[730px] sm:max-lg:h-[450px] lg:h-[650px] xl:h-[450px]'>
              <FiveStars />
